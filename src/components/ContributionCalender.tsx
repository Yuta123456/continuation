...
const ContributionCalender: React.FC = () => {
  ...
  return <Calendar panelColors={panelColors} panelAttributes={undefined} until={until} weekNames={weekNames} weekLabelAttributes={undefined} monthNames={monthNames} monthLabelAttributes={undefined} values={contributionData} dateFormat={dateFormat} />
}
